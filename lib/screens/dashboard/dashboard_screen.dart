    ...
    return Scaffold(
        ...
        body: Column(
          children: [
              ...
              child: Stack(
                ...
                children: <Widget>[
                  ...
                  Positioned(
                    ...
                    left: 30,
                    right: 30,
                    child: DashboardCard(width: width, height: height),
                  ),
                  Positioned(
                    top: height * .07,
                    left: 40.sp,
            ...
            Expanded(
              child: Padding(
                padding: EdgeInsets.only(top: 5.sp, right: 20.sp, left: 20.sp),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              transactionList[int].isReceiver == true ? "+ \$" + transactionList[int].amount!.toStringAsFixed(0): "- \$" + transactionList[int].amount!.toStringAsFixed(0),
                              style: TextStyle(
                                fontSize: 12.sp,
                                fontFamily: 'Rubik',
                                color: darkGrey,
